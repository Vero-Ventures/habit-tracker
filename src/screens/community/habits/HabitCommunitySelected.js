...
import { storeCommunityHabit } from "../../../store/ducks/community";
import { Picker } from "@react-native-picker/picker";
import { LinearGradient } from "expo-linear-gradient";
import ActionSheet from "react-native-actionsheet";

const HabitCommunitySelected = (props) => {
  ...
  const addHabit = async () => {
    ...
    const data_frequency = JSON.stringify({
      type: frequency_type,
    });

    let communityHabitForm = new FormData();

    communityHabitForm.append("coh_id_habit", props.route.params.hab_id);
    communityHabitForm.append(
      "coh_id_community",
      props.route.params.community.id,
    );
    communityHabitForm.append("coh_frequency", data_frequency);

    storeCommunityHabit(communityHabitForm)
      .catch((err) => {
        Alert.alert(
          "Ops!",
          "Something went wrong with our servers. Please contact us.",
        ...
        <Fetching isFetching={fetching}>
          ...
          <View style={styles.container}>
            <View style={styles.innerContainer}>
              <View style={styles.containerTitleInformation}>
...
export default HabitCommunitySelected;
